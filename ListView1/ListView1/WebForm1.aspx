<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="ListView1.WebForm1" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:lalkrishnanConnectionString %>" ProviderName="<%$ ConnectionStrings:lalkrishnanConnectionString.ProviderName %>" SelectCommand="SELECT * FROM [Table_7]"></asp:SqlDataSource>
        </div>
    </form>
</body>
</html>
